...
const AddTemplatePopup: React.FC<AddTemplatePopupProps> = ({ onClose, onSave }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div ref={popupRef} className="bg-white p-5 rounded shadow-lg w-96 max-h-3/4 overflow-y-auto relative z-50">
                <h2 className="text-xl font-bold mb-5 text-center text-black">Add New Template</h2>
                <input
                    type="text"
                ...
                {hasMap && (
                    <div>
                        <MapContainer className="w-full h-64" center={position} zoom={16}>
                            <ClickableMarker />
                            <TileLayer
